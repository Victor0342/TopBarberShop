    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <ParallaxImage src="/imagini/Locatie-Exterior.png" alt="Interior TopBarberShop" className="relative h-[360px] overflow-hidden rounded-3xl border border-border/60" />
        </div>
      </section>
